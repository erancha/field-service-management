...
// jsdom implements no layout, so Element#scrollIntoView does not exist there; components that
// scroll a focused control into view need it present (as a no-op) to render under tests.
